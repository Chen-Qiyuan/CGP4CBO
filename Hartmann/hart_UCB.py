...
if __name__ == "__main__":
    ...
    pd.DataFrame(BOD_table).T.to_excel("hart_ucb_bod.xlsx", index=False, engine='openpyxl')
    pd.DataFrame(simple_table).T.to_excel("hart_ucb_int.xlsx", index=False, engine='openpyxl')

import torch
from botorch.test_functions import Hartmann, Cosine8, Ackley, Levy
...
if __name__ == "__main__":
    ...
    import pandas as pd
    pd.DataFrame(BOD_table).T.to_excel("levy_fts_bod.xlsx", index=False, engine='openpyxl')
    pd.DataFrame(simple_table).T.to_excel("levy_fts_int.xlsx", index=False, engine='openpyxl')

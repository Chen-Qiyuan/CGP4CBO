...
if __name__ == "__main__":
    ...
    import pandas as pd
    pd.DataFrame(BOD_table).T.to_excel("levy_cts_bod.xlsx", index=False, engine='openpyxl')
    pd.DataFrame(simple_table).T.to_excel("levy_cts_int.xlsx", index=False, engine='openpyxl')
